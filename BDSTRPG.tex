...
graph in a small ``neighbourhood'' of our space of graphs. This
...
pair of such sets. If this is true, it follows that $\left|N_{\R}\left(S\right)\right|\ge\left|B\right|-\beta n$,
...
\end{lem}
This version of Szemeredi's regularity lemma is just the ``degree
...
pair of sets of size $\Omega\left(n\right)$ (we can prove this with
basically the same argument as in the proof of \ref{lem:bipartite-perturbed-stars}).
